...
WhitneyGroup:
	...
	db 32, TAUROS
			...
			dw $9411, $9411, $9411, $9411, $9411
			db BERSERK_GENE
			db ICY_WIND, STOMP, PURSUIT, HORN_ATTACK
	db -1 ; end
...
BugsyGroup:
	...
	db 22, PINSIR
			...
			dw $0008, $0008, $0008, $0008, $0008
			db NO_ITEM
			db HARDEN, ROCK_TOMB, VITAL_THROW, FURY_CUTTER
	db 24, SCIZOR
			db $cc, $cc ; atk|def, spd|spc
			dw $0008, $0008, $0008, $0008, $0008
			db FOCUS_BAND
...
PryceGroup:
	...
	db 51, SNEASEL
			...
			db FOCUS_BAND
			db SURF, BEAT_UP, GLACIAL_SLAM, PURSUIT
	db 51, DELIBIRD
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db SHARP_BEAK
			db ICE_BEAM, DRILL_PECK, SPIKES, THIEF
	db 52, CORSOLA
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db MYSTIC_WATER
			db SURF, GLACIAL_SLAM, TOXIC, RECOVER
	db 52, JYNX
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db BERRY_JUICE
			db PSYCHIC_M, ICE_BEAM, MEAN_LOOK, SING
	db 52, STANTLER
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db LEFTOVERS
	...
	db 53, PILOSWINE
			...
			dw $5046, $5046, $5046, $5046, $5046
			db NEVERMELTICE
			db ICY_WIND, GLACIAL_SLAM, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end
...
ChuckGroup:
	...
	db 44, HERACROSS
			...
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db FOCUS_BAND
			db MEGAHORN, STRENGTH, EARTHQUAKE, SUBMISSION
	db 43, KANGASKHAN
			db $bf, $bf ; atk|def, spd|spc
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db SPELL_TAG
			db SHADOW_BALL, MEGA_PUNCH, DRAIN_PUNCH, DISABLE
	db 45, POLIWRATH
			db $ee, $ee ; atk|def, spd|spc
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db LEFTOVERS
			db LOVELY_KISS, DRAIN_PUNCH, HYDRO_PUMP, ICE_BEAM
	db -1 ; end
...
ClairGroup:
	...
	db 58, MAGMAR
			...
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db MIRACLEBERRY
			db FIRE_BLAST, THUNDERBOLT, HYPNOSIS, SUNNY_DAY
	db 59, GYARADOS
			db $bb, $bb ; atk|def, spd|spc
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db MYSTIC_WATER
			db HYDRO_PUMP, EARTHQUAKE, FIRE_BLAST, TOXIC
	db 59, DRAGONITE
			db $bb, $bb ; atk|def, spd|spc
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db GOLD_BERRY
			db DRAGONBREATH, HYPER_BEAM, AIR_CUTTER, ICE_BEAM
	db 58, CHARIZARD
			db $bb, $bb ; atk|def, spd|spc
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db CHARCOAL
...
Rival0Group:
	...
	db 23, CROCONAW
			...
			dw $0008, $0008, $0008, $0008, $0008
			db MYSTIC_WATER
			db WATER_PULSE, BITE, SCARY_FACE, CUT
	db -1 ; end
...
Rival1Group:
	...
	db 32, KADABRA
			...
			dw $9411, $9411, $9411, $9411, $9411
			db NO_ITEM
			db PSYBEAM, FIRE_PUNCH, DISABLE, RECOVER
	db 34, BAYLEEF
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $9411, $9411, $9411, $9411, $9411
			db MIRACLE_SEED
			db GIGA_DRAIN, LIGHT_SCREEN, SYNTHESIS, LEECH_SEED
	db -1 ; end
	...
	db 34, FERALIGATR
			...
			dw $9411, $9411, $9411, $9411, $9411
			db MYSTIC_WATER
			db SURF, ROCK_TOMB, ICY_WIND, MUD_SLAP
	db -1 ; end
	...
	db 52, ALAKAZAM
			...
			dw $5046, $5046, $5046, $5046, $5046
			db TWISTEDSPOON
			db PSYCHIC_M, FIRE_PUNCH, REFLECT, RECOVER
	db 53, GENGAR
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db FOCUS_BAND
			db THUNDERBOLT, ICE_PUNCH, EXPLOSION, DYNAMICPUNCH
	db 51, GOLBAT
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db SILVERPOWDER
			db SLUDGE_BOMB, LEECH_LIFE, CONFUSE_RAY, AIR_CUTTER
	db 53, MAGNETON
			db $ed, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db LEFTOVERS
	...
	db 54, SNEASEL
			...
			dw $5046, $5046, $5046, $5046, $5046
			db BLACKGLASSES
			db THIEF, GLACIAL_SLAM, PURSUIT, REFLECT
	db 55, MEGANIUM
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db MIRACLE_SEED
	...
	db 55, FERALIGATR
			...
			dw $5046, $5046, $5046, $5046, $5046
			db MYSTIC_WATER
			db HYDRO_PUMP, GLACIAL_SLAM, ROCK_SLIDE, EARTHQUAKE
	db -1 ; end
...
WillGroup:
	...
	db 90, HYPNO
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db TWISTEDSPOON
			db PSYCHIC_M, REST, FUTURE_SIGHT, SLEEP_TALK
	db 91, XATU
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db MIRACLEBERRY
...
BrunoGroup:
	...
	db 68, MACHAMP
			...
			dw $3075, $3075, $3075, $3075, $3075
			db QUICK_CLAW
			db ROCK_SLIDE, DYNAMICPUNCH, EARTHQUAKE, HIDDEN_POWER
	db -1 ; end
...
KarenGroup:
	...
	db 67, PERSIAN
			...
			dw $3075, $3075, $3075, $3075, $3075
			db BLACKGLASSES
			db CRUNCH, SWAGGER, HYPNOSIS, THUNDER
	db 68, HOUNDOOM
			db $bb, $cc ; atk|def, spd|spc
			dw $3075, $3075, $3075, $3075, $3075
			db CHARCOAL
	...
	db 91, OCTILLERY
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db BLACKGLASSES
			db OCTAZOOKA, FLAMETHROWER, HYDRO_PUMP, HYPER_BEAM
	db 91, SNEASEL
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db NEVERMELTICE
			db BEAT_UP, GLACIAL_SLAM, SURF, MOONLIGHT
	db 92, GYARADOS
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db GOLD_B_JUICE
			db OUTRAGE, HYDRO_PUMP, GLACIAL_SLAM, HYPER_BEAM
	db 91, UMBREON
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db LEFTOVERS
...
KogaGroup:
	...
	db 66, MUK
			...
			dw $3075, $3075, $3075, $3075, $3075
			db POISON_BARB
			db SLUDGE_BOMB, GIGA_DRAIN, EXPLOSION, DISABLE
	db 67, CROBAT
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $3075, $3075, $3075, $3075, $3075
			db SHARP_BEAK
			db AIR_CUTTER, TOXIC, MEAN_LOOK, SLUDGE_BOMB
	db -1 ; end
	...
	db 91, ARTICUNO
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db BRIGHTPOWDER
			db HURRICANE, BLIZZARD, REST, SLEEP_TALK
	db 90, VENOMOTH
			db PERFECT_DV, $fb ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db LEFTOVERS
...
ChampionGroup:
	...
	db 69, DRAGONITE
			...
			db FOCUS_BAND
			db THUNDER, DRAGON_RAGE, ICE_BEAM, AIR_CUTTER
	db 69, CHARIZARD
			db $ed, $db ; atk|def, spd|spc
			dw $007D, $007D, $007D, $007D, $007D
			db LEFTOVERS
			db FIRE_BLAST, OUTRAGE, EARTHQUAKE, WILL_O_WISP
	db 70, GYARADOS
			db $fb, $df ; atk|def, spd|spc
			dw $007D, $007D, $007D, $007D, $007D
			db GOLD_B_JUICE
			db OUTRAGE, EARTHQUAKE, HYDRO_PUMP, HYPER_BEAM
	db 70, AERODACTYL
	...
	db 71, DRAGONITE
			...
			dw $007D, $007D, $007D, $007D, $007D
			db KINGS_ROCK
			db ROCK_SLIDE, HURRICANE, OUTRAGE, MEGA_KICK
	db -1 ; end
...
BrockGroup:
	...
	db 85, CROBAT
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db LEFTOVERS
			db AIR_CUTTER, SLUDGE_BOMB, TOXIC, CONFUSE_RAY
	db 85, SUDOWOODO
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db LEFTOVERS
	...
	db 86, MAGCARGO
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db GOLD_B_JUICE
			db FIRE_BLAST, SPIKES, RECOVER, ROCK_SLIDE
	db 87, TYRANITAR
			db PERFECT_DV, $bf ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db HARD_STONE
			db ROCK_SLIDE, CRUNCH, EARTHQUAKE, GLACIAL_SLAM
	db 87, KABUTOPS
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db KINGS_ROCK
			db HYDRO_PUMP, CUT, ROCK_SLIDE, EXTREMESPEED
	db 88, GOLEM
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db FOCUS_BAND
...
MistyGroup:
	...
	db 77, FERALIGATR
			...
			db SOFT_SAND
			db EARTHQUAKE, RAIN_DANCE, HYDRO_PUMP, DYNAMICPUNCH
	db 78, LANTURN
	...
	db 77, KINGLER
			...
			dw $409C, $409C, $409C, $409C, $409C
			db BERRY_JUICE
			db BIND, CRABHAMMER, DRAIN_PUNCH, BODY_SLAM
	db 78, VAPOREON
			db $bf, $fd ; atk|def, spd|spc
			dw $409C, $409C, $409C, $409C, $409C
			db LEFTOVERS
...
LtSurgeGroup:
	...
	db 73, RAICHU
			...
			dw $D084, $D084, $D084, $D084, $D084
			db LEFTOVERS
			db THUNDER, RAIN_DANCE, SURF, GLACIAL_SLAM
	db -1 ; end
...
ScientistGroup:
	...
	db 85, FLAREON
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db WILL_O_WISP, FLAMETHROWER, SEISMIC_TOSS, IRON_TAIL
	db 85, DITTO
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db 85, RAPIDASH
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FIRE_BLAST, HI_JUMP_KICK, TAKE_DOWN, HYPNOSIS
	db -1 ; end
	...
	db 87, MAGMAR
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db PSYCHIC_M, FIRE_BLAST, HYPNOSIS, THUNDERPUNCH
	db -1 ; end
	...
	db 87, HOUNDOOM
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db SUNNY_DAY, FIRE_BLAST, WILL_O_WISP, CRUNCH
	db 87, CHARIZARD
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FIRE_BLAST, SOLARBEAM, DRAGONBREATH, SUBMISSION
	db -1 ; end
	...
	db 86, MAGCARGO
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db ROCK_SLIDE, SOLARBEAM, FIRE_BLAST, AMNESIA
	db -1 ; end
...
ErikaGroup:
	...
	db 73, ARCANINE
			...
			dw $D084, $D084, $D084, $D084, $D084
			db CHARCOAL
			db FLAMETHROWER, SOLARBEAM, STRENGTH, SUNNY_DAY
	db 73, SUDOWOODO
			db PERFECT_DV, $bf ; atk|def, spd|spc
			dw $D084, $D084, $D084, $D084, $D084
			db HARD_STONE
	...
	db 76, BELLOSSOM
			...
			dw $D084, $D084, $D084, $D084, $D084
			db LEFTOVERS
			db LEECH_SEED, GIGA_DRAIN, WILL_O_WISP, PAIN_SPLIT
	db -1 ; end
...
YoungsterGroup:
	...
	db 85, PRIMEAPE
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db EARTHQUAKE, CROSS_CHOP, ROCK_SLIDE, BEAT_UP
	db -1 ; end
	...
	db 81, ARCANINE
			dw $409C, $409C, $409C, $409C, $409C
			db FIRE_BLAST, STRENGTH, TAKE_DOWN, EXTREMESPEED
	db -1 ; end
	...
	db 81, CROBAT
			dw $409C, $409C, $409C, $409C, $409C
			db SLUDGE_BOMB, TOXIC, CONFUSE_RAY, AIR_CUTTER
	db -1 ; end
	...
	db 39, RATICATE
			db $bb, $bb
			dw $0020, $0020, $0020, $0020, $0020
			db HYPER_FANG, SUPER_FANG, PURSUIT, DOUBLE_KICK
	db 41, RATICATE
			db PERFECT_DV, PERFECT_DV
			dw $0020, $0020, $0020, $0020, $0020
			db BODY_SLAM, SUPER_FANG, SUBSTITUTE, SHADOW_BALL
	...
	db 75, BUTTERFREE
			dw $409C, $409C, $409C, $409C, $409C
			db GIGA_DRAIN, PSYCHIC_M, SLEEP_POWDER, DREAM_EATER
	db 75, GIRAFARIG
			dw $409C, $409C, $409C, $409C, $409C
	...
	db 85, MURKROW
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db MEAN_LOOK, BEAT_UP, TOXIC, SKY_ATTACK
	db 85, ALAKAZAM
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db PSYCHIC_M, FIRE_PUNCH, RECOVER, KINESIS
	db -1 ; end
	...
	db 92, RATICATE
			...
			db NO_ITEM
			db HYPER_FANG, SUPER_FANG, PURSUIT, MIRROR_MOVE
	db 93, RATICATE
			db $bb, $bb
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db NO_ITEM
...
SchoolboyGroup:
	...
	db 84, MAGMAR
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db PSYCHIC_M, FIRE_BLAST, NIGHT_SHADE, THUNDERPUNCH
	db -1 ; end
	...
	db 76, HERACROSS
			dw $D084, $D084, $D084, $D084, $D084
			db CUT, SUBMISSION, SWAGGER, METAL_CLAW
	db 76, VILEPLUME
			dw $D084, $D084, $D084, $D084, $D084
	...
	db 81, PARASECT
			dw $409C, $409C, $409C, $409C, $409C
			db NO_ITEM
			db REFLECT, LEECH_LIFE, GIGA_DRAIN, STUN_SPORE
	db 81, POLIWRATH
			dw $409C, $409C, $409C, $409C, $409C
			db BERRY_JUICE
	...
	db 85, SCYTHER
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db WING_ATTACK, CUT, DOUBLE_TEAM, SWORDS_DANCE
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 39, CHARIZARD
			dw $0020, $0020, $0020, $0020, $0020
			db WING_ATTACK, FLAMETHROWER, DRAGON_RAGE, FIRE_SPIN
	db 41, PIDGEOT
			dw $0020, $0020, $0020, $0020, $0020
	...
	db 86, PIDGEOT
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db HYPER_BEAM, HURRICANE, MIRROR_MOVE, MUD_SLAP
	db -1 ; end
	...
	db 82, DRAGONITE
			dw $409C, $409C, $409C, $409C, $409C
			db OUTRAGE, FIRE_BLAST, HURRICANE, HYDRO_PUMP
	db -1 ; end
	...
	db 85, TOGETIC
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db AIR_CUTTER, MUD_SLAP, DOUBLE_EDGE, GIGA_DRAIN
	db 86, CROBAT
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db AIR_CUTTER, MEAN_LOOK, SLUDGE_BOMB, TOXIC
	db -1 ; end
	...
	db 92, TOGETIC
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db AIR_CUTTER, DOUBLE_EDGE, FIRE_BLAST, SAFEGUARD
	db 92, DRAGONITE
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db OUTRAGE, THUNDER, HURRICANE, ICE_BEAM
	db -1 ; end
...
LassGroup:
	...
	db 81, PIDGEOT
			dw $409C, $409C, $409C, $409C, $409C
			db HURRICANE, MIRROR_MOVE, DOUBLE_EDGE, SUBSTITUTE
	db 82, VENUSAUR
			dw $409C, $409C, $409C, $409C, $409C
	...
	db 50, GOLDUCK
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db SURF, PSYCHIC_M, CROSS_CHOP, HYPNOSIS
	db -1 ; end
	...
	db 56, GOLDUCK
			dw $5046, $5046, $5046, $5046, $5046
			db HYDRO_PUMP, PSYCHIC_M, CROSS_CHOP, HYPNOSIS
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 38, CHARIZARD
			db $bb, $bb
			dw $0020, $0020, $0020, $0020, $0020
			db FIRE_PUNCH, AIR_CUTTER, SMOKESCREEN, ROCK_TOMB
	db 38, BLASTOISE
			db $bb, $bb
			dw $0020, $0020, $0020, $0020, $0020
	...
	db 39, HERACROSS
			db PERFECT_DV, PERFECT_DV
			dw $0020, $0020, $0020, $0020, $0020
			db SUBMISSION, DOUBLE_EDGE, CUT, COUNTER
	db -1 ; end
	...
	db 56, DRAGONITE
			dw $5046, $5046, $5046, $5046, $5046
			db DRAGON_RAGE, AIR_CUTTER, THUNDERBOLT, EXTREMESPEED
	db -1 ; end
	...
	db 57, CHARMELEON
			dw $5046, $5046, $5046, $5046, $5046
			db DRAGON_RAGE, FIRE_BLAST, SMOKESCREEN, WILL_O_WISP
	db 57, SEADRA
			dw $5046, $5046, $5046, $5046, $5046
	...
	db 76, BLASTOISE
			dw $D084, $D084, $D084, $D084, $D084
			db HYDRO_PUMP, IRON_TAIL, SANDSTORM, ROCK_SLIDE
	db 77, RHYDON
			dw $D084, $D084, $D084, $D084, $D084
	...
	db 59, DRAGONITE
			dw $5046, $5046, $5046, $5046, $5046
			db DRAGON_RAGE, AIR_CUTTER, FLAMETHROWER, THUNDERBOLT
	db -1 ; end
	
	; COOLTRAINERM (21) - New Victory Road trainer
	db "CHRIS@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_MOVES
	db 61, LANTURN
			dw $C05D, $C05D, $C05D, $C05D, $C05D
	...
	db 63, TANGELA
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db SLEEP_POWDER, CONSTRICT, LEECH_SEED, GIGA_DRAIN
	db -1 ; end
	...
	db 92, TOGETIC
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db SHADOW_BALL, AIR_CUTTER, CHARM, SWEET_KISS
	db 92, STEELIX
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db EARTHQUAKE, SCREECH, SKULL_BASH, ROCK_SLIDE
	db 93, AMPHAROS
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db THUNDERBOLT, THUNDER_WAVE, LIGHT_SCREEN, FLAMETHROWER
	db 93, ALAKAZAM
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db PSYCHIC_M, REFLECT, RECOVER, ICE_PUNCH
	db 94, MEGANIUM
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db GIGA_DRAIN, BODY_SLAM, SYNTHESIS, LEECH_SEED
	db 94, KABUTOPS
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db ROCK_SLIDE, CUT, BLIZZARD, HYDRO_PUMP
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 38, FLAREON
			dw $0020, $0020, $0020, $0020, $0020
			db GROWTH, BATON_PASS, FLAME_WHEEL, WILL_O_WISP
	db 38, VAPOREON
			dw $0020, $0020, $0020, $0020, $0020
	...
	db 49, JUMPLUFF
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db SYNTHESIS, SLEEP_POWDER, GIGA_DRAIN, LEECH_SEED
	db 50, NINETALES
			dw $E02E, $E02E, $E02E, $E02E, $E02E
	...
	db 39, ARCANINE
			dw $0020, $0020, $0020, $0020, $0020
			db FLAME_WHEEL, BODY_SLAM, MUD_SLAP, WILL_O_WISP
	db -1 ; end
	...
	db 57, SUNFLORA
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db FIRE_BLAST, SOLARBEAM, STUN_SPORE, SUNNY_DAY
	db 58, MEGANIUM
			dw $C05D, $C05D, $C05D, $C05D, $C05D
	...
	db 85, VENUSAUR
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db GIGA_DRAIN, SLUDGE_BOMB, LEECH_SEED, SLEEP_POWDER
	db 86, STARMIE
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
	...
	db 77, NIDOQUEEN
			dw $409C, $409C, $409C, $409C, $409C
			db EARTHQUAKE, DYNAMICPUNCH, TOXIC, BODY_SLAM
	db 78, STARMIE
			dw $409C, $409C, $409C, $409C, $409C
			db BLIZZARD, PSYCHIC_M, HYDRO_PUMP, RECOVER
	db -1 ; end
...
BeautyGroup:
	...
	db 39, SCYTHER
			dw $0020, $0020, $0020, $0020, $0020
			db WING_ATTACK, FURY_CUTTER, DOUBLE_TEAM, PURSUIT
	db -1 ; end
	...
	db 82, BELLOSSOM
			dw $409C, $409C, $409C, $409C, $409C
			db GIGA_DRAIN, PAIN_SPLIT, WILL_O_WISP, SUBSTITUTE
	db 82, ARBOK
			dw $409C, $409C, $409C, $409C, $409C
			db EARTHQUAKE, SLUDGE_BOMB, SUBSTITUTE, GLARE
	db 82, VILEPLUME
...
PokemaniacGroup:
	...
	db 49, SLOWBRO
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db PSYCHIC_M, ICE_PUNCH, WHIRLPOOL, AMNESIA
	db -1 ; end
	...
	db 48, ELECTABUZZ
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db PSYCHIC_M, THUNDERBOLT, SUBSTITUTE, LIGHT_SCREEN
	db 48, NIDOKING
			dw $E02E, $E02E, $E02E, $E02E, $E02E
	...
	db 25, PIDGEOTTO
			dw $0008, $0008, $0008, $0008, $0008
			db QUICK_ATTACK, MUD_SLAP, WHIRLWIND, WING_ATTACK
	db 26, LICKITUNG
			dw $0008, $0008, $0008, $0008, $0008
	...
	db 25, SLOWPOKE
			dw $0008, $0008, $0008, $0008, $0008
			db WATER_PULSE, CONFUSION, DISABLE, HEADBUTT
	db 25, QUAGSIRE
			dw $0008, $0008, $0008, $0008, $0008
			db MAGNITUDE, HAZE, WATER_PULSE, SLAM
	db -1 ; end
	...
	db 46, NIDOKING
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db BODY_SLAM, ICE_BEAM, EARTHQUAKE, THUNDERBOLT
	db 46, NIDOQUEEN
			dw $E02E, $E02E, $E02E, $E02E, $E02E
	...
	db 78, CHARIZARD
			dw $409C, $409C, $409C, $409C, $409C
			db DRAGON_RAGE, FLAMETHROWER, ROCK_SLIDE, AIR_CUTTER
	db 78, KANGASKHAN
			dw $409C, $409C, $409C, $409C, $409C
			db MEGA_PUNCH, EARTHQUAKE, DYNAMICPUNCH, HYPER_BEAM
	db 79, GENGAR
			dw $409C, $409C, $409C, $409C, $409C
...
GruntMGroup:
	...
	db 50, RATICATE
			dw $5046, $5046, $5046, $5046, $5046
			db BODY_SLAM, ROCK_SMASH, SCREECH, SUPER_FANG
	db 51, GLIGAR
			dw $5046, $5046, $5046, $5046, $5046
			db EARTHQUAKE, SLASH, AIR_CUTTER, SCREECH
	db -1 ; end
	...
	db 53, WEEZING
			dw $5046, $5046, $5046, $5046, $5046
			db SLUDGE_BOMB, SCREECH, POISON_GAS, WILL_O_WISP
	db -1 ; end
	...
	db 54, WEEZING
			dw $5046, $5046, $5046, $5046, $5046
			db SMOKESCREEN, WILL_O_WISP, SLUDGE_BOMB, THUNDER
	db -1 ; end
	...
	db 48, RATICATE
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db ROCK_SMASH, SUBSTITUTE, SUPER_FANG, PURSUIT
	db 49, RHYHORN
			dw $E02E, $E02E, $E02E, $E02E, $E02E
	...
	db 76, CROBAT
			db $bb, $bb ; atk|def, spd|spc
			dw $D084, $D084, $D084, $D084, $D084
			db TOXIC, AIR_CUTTER, SLUDGE_BOMB, HAZE
	db 77, RAPIDASH
			db PERFECT_DV, PERFECT_DV
			dw $D084, $D084, $D084, $D084, $D084
			db REST, FIRE_BLAST, SLEEP_TALK, HI_JUMP_KICK
	db -1 ; end
...
TeacherGroup:
	...
	db 81, AIPOM
			dw $409C, $409C, $409C, $409C, $409C
			db CROSS_CHOP, MEGA_KICK, AGILITY, BATON_PASS
	db 82, MAROWAK
			dw $409C, $409C, $409C, $409C, $409C
	...
	db 72, DODRIO
			dw $D084, $D084, $D084, $D084, $D084
			db DRILL_PECK, TRI_ATTACK, SUBSTITUTE, HI_JUMP_KICK
	db -1 ; end
	...
	db 81, MEGANIUM
			dw $409C, $409C, $409C, $409C, $409C
			db GIGA_DRAIN, REFLECT, LEECH_SEED, SLEEP_POWDER
	db -1 ; end
...
SabrinaGroup:
	...
	db 83, MAGMAR
			...
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db SCOPE_LENS
			db FIRE_BLAST, THUNDERBOLT, PSYCHIC_M, EXPLOSION
	db 84, SLOWBRO
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db GOLD_B_JUICE
...
BugCatcherGroup:
	...
	db 83, BUTTERFREE
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db STUN_SPORE, PSYCHIC_M, GIGA_DRAIN, HURRICANE
	db 83, BEEDRILL
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
	...
	db 85, PINSIR
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db MEGAHORN, ROCK_SLIDE, SWORDS_DANCE, BEAT_UP
	db 84, BEEDRILL
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db SLUDGE_BOMB, TWINEEDLE, SWORDS_DANCE, HYPER_BEAM
	db -1 ; end
	...
	db 21, PARAS
			dw $0002, $0002, $0002, $0002, $0002
			db CUT, SPORE, LEECH_SEED, ABSORB
	db 22, HERACROSS
			dw $0002, $0002, $0002, $0002, $0002
	...
	db 84, SCYTHER
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db CUT, LIGHT_SCREEN, SWORDS_DANCE, WING_ATTACK
	db -1 ; end
	...
	db 84, HERACROSS
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db MEGAHORN, CROSS_CHOP, ROCK_SLIDE, EARTHQUAKE
	db -1 ; end
	...
	db 91, HERACROSS
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db EARTHQUAKE, CROSS_CHOP, MEGAHORN, COUNTER
	db 91, YANMA
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db DRAGONBREATH, LEECH_LIFE, AIR_CUTTER, WHIRLWIND
	db 92, PINSIR
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db ROCK_SLIDE, MEGAHORN, BEAT_UP, SWORDS_DANCE
	db 92, SHUCKLE
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
...
SuperNerdGroup:
	...
	db 37, VILEPLUME
			dw $0020, $0020, $0020, $0020, $0020
			db MOONLIGHT, ACID, SLEEP_POWDER, GIGA_DRAIN
	db -1 ; end
	...
	db 73, WEEZING
			dw $D084, $D084, $D084, $D084, $D084
			db SLUDGE_BOMB, FIRE_BLAST, DESTINY_BOND, WILL_O_WISP
	db -1 ; end
	...
	db 58, URSARING
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db EARTHQUAKE, CROSS_CHOP, REST, SNORE
	db 59, GIRAFARIG
			dw $C05D, $C05D, $C05D, $C05D, $C05D
	...
	db 45, MURKROW
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db MEAN_LOOK, FAINT_ATTACK, NIGHT_SHADE, DRILL_PECK
	db 46, SLOWKING
			dw $E02E, $E02E, $E02E, $E02E, $E02E
	...
	db 61, MILTANK
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db DYNAMICPUNCH, MILK_DRINK, ROLLOUT, DEFENSE_CURL
	db 63, HOUNDOOM
			dw $C05D, $C05D, $C05D, $C05D, $C05D
	...
	db 46, AZUMARILL
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db HYDRO_PUMP, SUBMISSION, WHIRLPOOL, DOUBLE_EDGE
	db 47, MR__MIME
			dw $E02E, $E02E, $E02E, $E02E, $E02E
	...
	db 86, SLOWBRO
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db AMNESIA, PSYCHIC_M, SURF, ICE_BEAM
	db -1 ; end
	...
	db 87, DRAGONITE
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db OUTRAGE, THUNDER, HURRICANE, HYDRO_PUMP
	db 87, GENGAR
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
...
FisherGroup:
	...
	db 80, SEAKING
			dw $409C, $409C, $409C, $409C, $409C
			db MEGAHORN, DRILL_PECK, HYDRO_PUMP, DOUBLE_EDGE
	db 81, POLIWRATH
			dw $409C, $409C, $409C, $409C, $409C
			db LOVELY_KISS, DRAIN_PUNCH, DREAM_EATER, SURF
	db -1 ; end
	...
	db 79, GYARADOS
			dw $409C, $409C, $409C, $409C, $409C
			db EARTHQUAKE, ROCK_SLIDE, GLACIAL_SLAM, HYDRO_PUMP
	db 80, QWILFISH
			dw $409C, $409C, $409C, $409C, $409C
	...
	db 92, SEAKING
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db MEGAHORN, DRILL_PECK, HYDRO_PUMP, WHIRLPOOL
	db 92, GYARADOS
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db HYDRO_PUMP, THUNDER, EARTHQUAKE, ICE_BEAM
	db -1 ; end
...
SwimmerMGroup:
	...
	db 42, FERALIGATR
			dw $0020, $0020, $0020, $0020, $0020
			db WATERFALL, CRUNCH, SCARY_FACE, SUBMISSION
	db -1 ; end
	...
	db 42, KINGLER
			dw $0020, $0020, $0020, $0020, $0020
			db CRABHAMMER, CLAMP, VICEGRIP, METAL_CLAW
	db -1 ; end
	...
	db 86, KINGLER
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db CRABHAMMER, DOUBLE_EDGE, CUT, DRAIN_PUNCH
	db -1 ; end
...
SwimmerFGroup:
	...
	db 40, SEEL
			dw $0020, $0020, $0020, $0020, $0020
			db SURF, RAIN_DANCE, ICE_BEAM, BODY_SLAM
	db 41, VAPOREON
			dw $0020, $0020, $0020, $0020, $0020
			db SURF, GROWTH, BATON_PASS, ICE_BEAM
	db 41, DEWGONG
			dw $0020, $0020, $0020, $0020, $0020
			db SURF, ICE_BEAM, BODY_SLAM, DISABLE
	db -1 ; end
	...
	db 85, SEAKING
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db MEGAHORN, DRILL_PECK, HYDRO_PUMP, CONFUSE_RAY
	db -1 ; end
	...
	db 76, KABUTOPS
			dw $D084, $D084, $D084, $D084, $D084
			db WATERFALL, EARTHQUAKE, ROCK_SLIDE, GIGA_DRAIN
	db 76, QUAGSIRE
			dw $D084, $D084, $D084, $D084, $D084
...
SailorGroup:
	...
	db 41, KINGLER
			dw $0020, $0020, $0020, $0020, $0020
			db CRABHAMMER, DRAIN_PUNCH, VICEGRIP, ROCK_TOMB
	db -1 ; end
...
Rival2Group:
	...
	db 63, SNEASEL
			...
			dw $3075, $3075, $3075, $3075, $3075
			db NEVERMELTICE
			db BEAT_UP, ICE_BEAM, SWORDS_DANCE, EARTHQUAKE
	db 65, MEGANIUM
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $3075, $3075, $3075, $3075, $3075
			db LEFTOVERS
			db GIGA_DRAIN, REFLECT, LEECH_SEED, SYNTHESIS
	db -1 ; end
	...
	db 65, TYPHLOSION
			...
			dw $3075, $3075, $3075, $3075, $3075
			db MIRACLEBERRY
			db FIRE_BLAST, THUNDERPUNCH, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end
	...
	db 86, CROBAT
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db POISON_BARB
			db SLUDGE_BOMB, LEECH_LIFE, TOXIC, AIR_CUTTER
	db 85, MAGNETON
			db $ed, $bb ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db QUICK_CLAW
	...
	db 87, MEGANIUM
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db LEFTOVERS
			db GIGA_DRAIN, EARTHQUAKE, LEECH_SEED, SYNTHESIS
	db -1 ; end
	...
	db 87, TYPHLOSION
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db MIRACLEBERRY
			db FIRE_BLAST, THUNDERPUNCH, EARTHQUAKE, SUBMISSION
	db -1 ; end
...
HikerGroup:
	...
	db 70, PILOSWINE
			dw $3075, $3075, $3075, $3075, $3075
			db EARTHQUAKE, GLACIAL_SLAM, REST, SLEEP_TALK
	db -1 ; end
	...
	db 33, DONPHAN
			dw $9411, $9411, $9411, $9411, $9411
			db MAGNITUDE, HORN_ATTACK, ROCK_TOMB, QUICK_ATTACK
	db -1 ; end
	...
	db 75, STEELIX
			dw $D084, $D084, $D084, $D084, $D084
			db EARTHQUAKE, IRON_TAIL, BIND, CURSE
	db -1 ; end
...
BikerGroup:
	...
	db 83, ARCANINE
			dw $409C, $409C, $409C, $409C, $409C
			db FLAMETHROWER, SOLARBEAM, SUNNY_DAY, STRENGTH
	db -1 ; end
	...
	db 80, WEEZING
			dw $409C, $409C, $409C, $409C, $409C
			db ZAP_CANNON, FIRE_BLAST, SLUDGE_BOMB, WILL_O_WISP
	db 80, WEEZING
			dw $409C, $409C, $409C, $409C, $409C
	...
	db 81, MAGMAR
			dw $409C, $409C, $409C, $409C, $409C
			db FLAMETHROWER, THUNDERBOLT, CONFUSE_RAY, SUBSTITUTE
	db -1 ; end
	...
	db 81, MAGMAR
			dw $409C, $409C, $409C, $409C, $409C
			db FIRE_BLAST, THUNDERBOLT, CONFUSE_RAY, SUBSTITUTE
	db -1 ; end
	...
	db 82, FLAREON
			db $fd, $bb
			dw $409C, $409C, $409C, $409C, $409C
			db FIRE_SPIN, TOXIC, FLAMETHROWER, PROTECT
	db -1 ; end
	...
	db 81, CROBAT
			dw $409C, $409C, $409C, $409C, $409C
			db LEECH_LIFE, SLUDGE_BOMB, TOXIC, AIR_CUTTER
	db 82, MUK
			dw $409C, $409C, $409C, $409C, $409C
			db SLUDGE_BOMB, EXPLOSION, CURSE, GIGA_DRAIN
	db -1 ; end
...
BlaineGroup:
	...
	db 88, MOLTRES
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db MINT_BERRY
			db SOLARBEAM, FIRE_BLAST, REST, AIR_CUTTER
	db 87, MAGMAR
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db FOCUS_BAND
			db SUNNY_DAY, FIRE_BLAST, EXPLOSION, THUNDERBOLT
	db 89, ARCANINE
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db GOLD_B_JUICE
...
BurglarGroup:
	...
	db 52, KOFFING
			dw $5046, $5046, $5046, $5046, $5046
			db EXPLOSION, WILL_O_WISP, SLUDGE_BOMB, SMOKESCREEN
	db 54, MAGMAR
			dw $5046, $5046, $5046, $5046, $5046
			db FIRE_BLAST, PSYCHIC_M, CONFUSE_RAY, SUBSTITUTE
	db 54, WEEZING
			dw $5046, $5046, $5046, $5046, $5046
			db DESTINY_BOND, WILL_O_WISP, SLUDGE_BOMB, HAZE
	db -1 ; end
	...
	db 52, GROWLITHE
			dw $5046, $5046, $5046, $5046, $5046
			db FLAMETHROWER, TAKE_DOWN, AGILITY, BODY_SLAM
	db 52, KOFFING
			dw $5046, $5046, $5046, $5046, $5046
			db EXPLOSION, WILL_O_WISP, SLUDGE_BOMB, SMOKESCREEN
	db 53, ARCANINE
	...
	db 82, MAGCARGO
			dw $409C, $409C, $409C, $409C, $409C
			db FIRE_BLAST, SOLARBEAM, SUNNY_DAY, WILL_O_WISP
	db 82, OCTILLERY
			dw $409C, $409C, $409C, $409C, $409C
			db OCTAZOOKA, FLAMETHROWER, SURF, HYPER_BEAM
	db 82, NIDOQUEEN
			dw $409C, $409C, $409C, $409C, $409C
...
FirebreatherGroup:
	...
	db 31, GROWLITHE
			dw $9411, $9411, $9411, $9411, $9411
			db FLAME_WHEEL, STOMP, LEER, BITE
	db 32, OCTILLERY
			dw $9411, $9411, $9411, $9411, $9411
	...
	db 85, MAGMAR
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FLAMETHROWER, NIGHT_SHADE, PSYCHIC_M, THUNDERBOLT
	db 85, MAGMAR
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FLAMETHROWER, NIGHT_SHADE, PSYCHIC_M, THUNDERBOLT
	db -1 ; end
	...
	db 70, FLAREON
			dw $3075, $3075, $3075, $3075, $3075
			db GROWTH, TOXIC, BATON_PASS, FIRE_SPIN
	db 69, MUK
			dw $3075, $3075, $3075, $3075, $3075
	...
	db 73, TYPHLOSION
			dw $D084, $D084, $D084, $D084, $D084
			db THUNDERPUNCH, FIRE_BLAST, EARTHQUAKE, SUBMISSION
	db 73, ARCANINE
			dw $D084, $D084, $D084, $D084, $D084
			db FIRE_BLAST, STRENGTH, TAKE_DOWN, EXTREMESPEED
	db -1 ; end
	...
	db 94, MAGMAR
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db FIRE_BLAST, PSYCHIC_M, THUNDERBOLT, SUNNY_DAY
	db 94, FLAREON
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db FLAMETHROWER, REST, SLEEP_TALK, ZAP_CANNON
	db 94, WEEZING
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
	...
	db 95, RAPIDASH
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db FIRE_BLAST, HI_JUMP_KICK, HYPNOSIS, MORNING_SUN
	db -1 ; end
...
JugglerGroup:
	...
	db 69, MAGMAR
			dw $3075, $3075, $3075, $3075, $3075
			db FIRE_BLAST, HYPNOSIS, DREAM_EATER, SUBSTITUTE
	db 70, MACHAMP
			dw $3075, $3075, $3075, $3075, $3075
			db ROCK_SLIDE, CROSS_CHOP, EARTHQUAKE, FOCUS_ENERGY
	db -1 ; end
...
BlackbeltGroup:
	...
	db 60, HERACROSS
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db MEGAHORN, CROSS_CHOP, COUNTER, HORN_ATTACK
	db 61, RHYDON
			dw $C05D, $C05D, $C05D, $C05D, $C05D
			db CURSE, EARTHQUAKE, ZAP_CANNON, ROCK_SLIDE
	db 61, POLIWRATH
...
ExecutiveMGroup:
	...
	db 53, SHUCKLE
			dw $5046, $5046, $5046, $5046, $5046
			db WITHDRAW, BATON_PASS, ENCORE, WRAP
	db 53, NOCTOWL
			dw $5046, $5046, $5046, $5046, $5046
			db HYPNOSIS, DREAM_EATER, TAKE_DOWN, REFLECT
	db 54, VENUSAUR
...
PsychicGroup:
	...
	db 38, SLOWBRO
			dw $0020, $0020, $0020, $0020, $0020
			db WATERFALL, PSYBEAM, WITHDRAW, DISABLE
	db -1 ; end
...
PicnickerGroup:
	...
	db 82, WEEZING
			dw $409C, $409C, $409C, $409C, $409C
			db PERISH_SONG, FIRE_BLAST, WILL_O_WISP, SLUDGE_BOMB
	db 83, NIDOQUEEN
			dw $409C, $409C, $409C, $409C, $409C
	...
	db 55, MUK
			dw $5046, $5046, $5046, $5046, $5046
			db SLUDGE_BOMB, GIGA_DRAIN, LICK, DRAIN_PUNCH
	db 56, CLEFABLE
			dw $5046, $5046, $5046, $5046, $5046
	...
	db 47, NIDOKING
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db SURF, SLUDGE_BOMB, EARTHQUAKE, ROCK_SLIDE
	db 48, NIDOQUEEN
			dw $E02E, $E02E, $E02E, $E02E, $E02E
...
CamperGroup:
	...
	db 25, PSYDUCK
			dw $0008, $0008, $0008, $0008, $0008
			db WATER_PULSE, CONFUSION, DISABLE, HYPNOSIS
	db 25, PIDGEOTTO
			dw $0008, $0008, $0008, $0008, $0008
	...
	db 76, RAPIDASH
			dw $D084, $D084, $D084, $D084, $D084
			db FIRE_BLAST, DOUBLE_EDGE, HI_JUMP_KICK, EXTREMESPEED
	db 77, NIDOKING
			dw $D084, $D084, $D084, $D084, $D084
			db LOVELY_KISS, EARTHQUAKE, THUNDER, ROCK_SLIDE
	db -1 ; end
	...
	db 74, GOLDUCK
			dw $D084, $D084, $D084, $D084, $D084
			db THUNDERBOLT, CROSS_CHOP, HYPNOSIS, WATERFALL
	db 75, SANDSLASH
			dw $D084, $D084, $D084, $D084, $D084
			db EARTHQUAKE, IRON_TAIL, CUT, SUBSTITUTE
	db 74, PIDGEOT
	...
	db 55, TAUROS
			dw $5046, $5046, $5046, $5046, $5046
			db THRASH, EARTHQUAKE, MEGAHORN, ROCK_SLIDE
	db -1 ; end
	...
	db 79, SNEASEL
			db $bb, $bb ; atk|def, spd|spc
			dw $409C, $409C, $409C, $409C, $409C
			db BEAT_UP, ICE_BEAM, HI_JUMP_KICK, REFLECT
	db 80, SANDSLASH
	...
	db 82, NIDOKING
			dw $409C, $409C, $409C, $409C, $409C
			db SLUDGE_BOMB, EARTHQUAKE, ICE_BEAM, THUNDERBOLT
	db -1 ; end
...
SageGroup:
	...
	db 34, HAUNTER
			dw $9411, $9411, $9411, $9411, $9411
			db MEAN_LOOK, DESTINY_BOND, CURSE, CONFUSE_RAY
	db -1 ; end
	...
	db 56, FLAREON
			dw $5046, $5046, $5046, $5046, $5046
			db WILL_O_WISP, FLAMETHROWER, FIRE_SPIN, ZAP_CANNON
	db -1 ; end
...
MediumGroup:
	...
	db 32, GASTLY
			dw $9411, $9411, $9411, $9411, $9411
			db LICK, CONFUSE_RAY, CURSE, MEAN_LOOK
	db 33, HAUNTER
			dw $9411, $9411, $9411, $9411, $9411
...
BoarderGroup:
	...
	db 51, DEWGONG
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db TAKE_DOWN, ICE_BEAM, SURF, MEGAHORN
	db -1 ; end
	...
	db 95, SNEASEL
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db BEAT_UP, GLACIAL_SLAM, PURSUIT, CROSS_CHOP
	db 95, LAPRAS
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
...
RedGroup:
	...
	db 99, POLIWRATH
			...
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db QUICK_CLAW
			db CROSS_CHOP, HYDRO_PUMP, EARTHQUAKE, LOVELY_KISS
	db 99, MEWTWO
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db BERSERK_GENE
...
BlueGroup:
	...
	db 89, SCYTHER
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db SILVERPOWDER
			db CUT, BATON_PASS, SWORDS_DANCE, WING_ATTACK
	db 90, ZAPDOS
			db PERFECT_DV, $bf ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db BRIGHTPOWDER
...
PKMNTrainer3Group:			
	...
	db 94, FLAREON
			...
			dw $90E2, $90E2, $90E2, $90E2, $90E2
			db CHARCOAL
			db FIRE_SPIN, SEISMIC_TOSS, REST, SLEEP_TALK
	db 95, BLASTOISE
			db $fb, PERFECT_DV ; atk|def, spd|spc
			dw $90E2, $90E2, $90E2, $90E2, $90E2
			db MIRACLEBERRY
...
AndreaGroup:
	...
	db 100, GYARADOS
			...
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db GOLD_B_JUICE
			db OUTRAGE, HYDRO_PUMP, THUNDER, FIRE_BLAST
	db 100, EXEGGUTOR
			db PERFECT_DV, PERFECT_DV
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db MIRACLE_SEED
	...
	db 100, GHOST_P
			...
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db THICK_CLUB
			db WILL_O_WISP, SHADOW_BALL, BONE_RUSH, ROCK_SLIDE
	db 100, HO_OH
			db $bf, PERFECT_DV
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db CHARCOAL
...
Morty2Group:
	...
	db 82, GHOST_P
			...
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db THICK_CLUB
			db SWORDS_DANCE, BONE_RUSH, WILL_O_WISP, SHADOW_BALL
	db 82, MISDREAVUS
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db LEFTOVERS
...
Clair2Group:
	...
	db 91, MAGMAR
			...
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db SCOPE_LENS
			db FIRE_BLAST, THUNDERBOLT, DRAGONBREATH, HYPNOSIS
	db 93, GYARADOS
			db PERFECT_DV, $bf
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db MIRACLEBERRY
			db OUTRAGE, EARTHQUAKE, THUNDER, HYDRO_PUMP
	db 92, EXEGGUTOR
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db BRIGHTPOWDER
	...
	db 92, DRAGONITE
			...
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db FOCUS_BAND
			db OUTRAGE, FIRE_BLAST, HURRICANE, ICE_BEAM
	db 94, BLISSEY
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db LUCKY_PUNCH
...
Champion2Group:
	...
	db 100, GYARADOS
			...
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db MIRACLEBERRY
			db OUTRAGE, RAIN_DANCE, HYDRO_PUMP, THUNDER
	db 100, CHARIZARD
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db GOLD_B_JUICE
	...
	db 100, TYRANITAR
			...
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db HARD_STONE
			db ROCK_SLIDE, PURSUIT, RAIN_DANCE, EARTHQUAKE
	db 100, KINGDRA
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db BRIGHTPOWDER
	...
	db 100, CELEBI
			...
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db LEFTOVERS
			db HEAL_BELL, LEECH_SEED, GIGA_DRAIN, PSYCHIC_M
	db 100, DRAGONITE
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db SCOPE_LENS
			db ROCK_SLIDE, HURRICANE, OUTRAGE, THUNDER
	db -1 ; end
...
KingGroup:
	...
	db 85, MAGMAR
			db $bf, PERFECT_DV
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FIRE_BLAST, HYPNOSIS, DREAM_EATER, REFLECT
	db 86, HITMONTOP
			db PERFECT_DV, PERFECT_DV
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
	...
	db 86, HERACROSS
			db PERFECT_DV, PERFECT_DV
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db MEGAHORN, CROSS_CHOP, SWORDS_DANCE, ROCK_SLIDE
	db -1 ; end
...
GiovanniGroup:
	...
	db 83, KANGASKHAN
			...
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db POLKADOT_BOW
			db DOUBLE_EDGE, EARTHQUAKE, DYNAMICPUNCH, SWORDS_DANCE
	db 84, NIDOKING
			db PERFECT_DV, $fb ; atk|def, spd|spc
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db SOFT_SAND
	...
	db 85, RHYDON
			...
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FOCUS_BAND
			db EARTHQUAKE, ROCK_SLIDE, MEGAHORN, THUNDER
	db -1 ; end
...
RoughneckGroup:
	...
	db 83, SNEASEL
			db $bf, PERFECT_DV ; atk|def, spd|spc
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db GLACIAL_SLAM, BEAT_UP, THIEF, REFLECT
	db 84, TENTACRUEL
			db $fb, PERFECT_DV ; atk|def, spd|spc
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
...
; PETREL (1) - Hideout
	...
	db 50, WEEZING
			dw $5046, $5046, $5046, $5046, $5046
			db DESTINY_BOND, SLUDGE_BOMB, WILL_O_WISP, POISON_GAS
	db 50, RATICATE
			dw $5046, $5046, $5046, $5046, $5046
...
; PETREL (2) - Radio Tower Director
	...
	db 54, WEEZING
			db $cc, $cc ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db EXPLOSION, SLUDGE_BOMB, WILL_O_WISP, POISON_GAS
	db -1 ; end
