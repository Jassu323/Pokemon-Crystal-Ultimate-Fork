...
WhitneyGroup:
	...
	db 32, TAUROS
			...
			dw $9411, $9411, $9411, $9411, $9411
			db BERSERK_GENE
			db ICY_WIND, STOMP, PURSUIT ; HORN_DRILL,
	db -1 ; end
...
MortyGroup:
	...
	db 36, GENGAR
			...
			dw $0020, $0020, $0020, $0020, $0020
			db BRIGHTPOWDER
			db HYPNOSIS, DREAM_EATER, SHADOW_BALL ; DYNAMICPUNCH
	db 36, MISDREAVUS
			db $bb, $bb ; atk|def, spd|spc
			dw $0020, $0020, $0020, $0020, $0020
			db LEFTOVERS
...
ChuckGroup:
	...
	db 45, POLIWRATH
			...
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db LEFTOVERS
			db LOVELY_KISS, DRAIN_PUNCH, HYDRO_PUMP, ROCK_SLIDE
	db -1 ; end
...
Rival0Group:
	...
	db 23, CROCONAW
			...
			dw $0008, $0008, $0008, $0008, $0008
			db MYSTIC_WATER
			db WATER_GUN, BITE, SCARY_FACE, AIR_CUTTER
	db -1 ; end
...
Rival1Group:
	...
	db 53, GENGAR
			...
			dw $5046, $5046, $5046, $5046, $5046
			db FOCUS_BAND
			db THUNDERPUNCH, ICE_PUNCH, EXPLOSION ; DYNAMICPUNCH
	db 51, GOLBAT
			db $bb, $bb ; atk|def, spd|spc
			dw $5046, $5046, $5046, $5046, $5046
			db SILVERPOWDER
	...
	db 55, TYPHLOSION
			...
			dw $5046, $5046, $5046, $5046, $5046
			db CHARCOAL
			db FIRE_BLAST, THUNDERPUNCH, SUNNY_DAY ; DYNAMICPUNCH
	db -1 ; end
...
PKMNTrainerGroup:
	...
	db 86, TYPHLOSION
			...
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db CHARCOAL
			db SUNNY_DAY, FIRE_BLAST, THUNDERPUNCH ; DYNAMICPUNCH
	db 83, POLITOED
			db $bb, $bb ; atk|def, spd|spc
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db BRIGHTPOWDER
...
KogaGroup:
	...
	db 91, ARTICUNO
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db BRIGHTPOWDER
			db AIR_CUTTER, ICE_BEAM, REST, SLEEP_TALK
	db 90, VENOMOTH
			db PERFECT_DV, $fb ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db LEFTOVERS
...
ChampionGroup:
	...
	db 69, DRAGONITE
			...
			db FOCUS_BAND
			db THUNDER, DRAGON_RAGE, ICE_BEAM ; DYNAMICPUNCH
	db 69, CHARIZARD
	...
	db 70, AERODACTYL
			...
			dw $007D, $007D, $007D, $007D, $007D
			db HARD_STONE
			db ROCK_SLIDE, AIR_CUTTER, WHIRLWIND, EARTHQUAKE
	db 69, KINGDRA
			db $bb, $bb ; atk|def, spd|spc
			dw $007D, $007D, $007D, $007D, $007D
			db MYSTIC_WATER
	...
	db 71, DRAGONITE
			...
			dw $007D, $007D, $007D, $007D, $007D
			db KINGS_ROCK
			db ROCK_SLIDE, AIR_CUTTER, OUTRAGE, MEGA_KICK
	db -1 ; end
...
ScientistGroup:
	...
	db 85, RAPIDASH
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FIRE_BLAST, FIRE_SPIN, TAKE_DOWN ; HORN_DRILL,
	db -1 ; end
	...
	db 87, TYPHLOSION
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db FIRE_BLAST, THUNDERPUNCH, EARTHQUAKE ; DYNAMICPUNCH
	db -1 ; end
...
YoungsterGroup:
	...
	db 39, RATICATE
			db $bb, $bb
			dw $0020, $0020, $0020, $0020, $0020
			db HYPER_FANG, SUPER_FANG, PURSUIT ; MIMIC
	db 41, RATICATE
			db PERFECT_DV, PERFECT_DV
			dw $0020, $0020, $0020, $0020, $0020
			db BODY_SLAM, SUPER_FANG, SUBSTITUTE, SHADOW_BALL
...
SchoolboyGroup:
	...
	db 85, SCYTHER
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db AIR_CUTTER, CUT, DOUBLE_TEAM, SWORDS_DANCE
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 41, PIDGEOT
			dw $0020, $0020, $0020, $0020, $0020
			db AIR_CUTTER, WHIRLWIND, TAKE_DOWN, STEEL_WING
	db -1 ; end
	...
	db 86, PIDGEOT
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db HYPER_BEAM, AIR_CUTTER, MIRROR_MOVE, MUD_SLAP
	db -1 ; end
	...
	db 82, FARFETCH_D
			dw $409C, $409C, $409C, $409C, $409C
			db SWORDS_DANCE, RAZOR_LEAF, AIR_CUTTER, BODY_SLAM
	db -1 ; end
	...
	db 81, SCYTHER
			dw $409C, $409C, $409C, $409C, $409C
			db AIR_CUTTER, CUT, DOUBLE_TEAM, PURSUIT
	db -1 ; end
	...
	db 69, FARFETCH_D
			dw $3075, $3075, $3075, $3075, $3075
			db SWORDS_DANCE, AIR_CUTTER, RAZOR_LEAF, BATON_PASS
	db 70, SKARMORY
			dw $3075, $3075, $3075, $3075, $3075
			db STEEL_WING, CURSE, WHIRLWIND, DRILL_PECK
	db 69, PIDGEOT
	...
	db 82, DRAGONITE
			dw $409C, $409C, $409C, $409C, $409C
			db OUTRAGE, FIRE_BLAST, AIR_CUTTER, SURF
	db -1 ; end
	...
	db 92, DRAGONITE
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db OUTRAGE, THUNDER, AIR_CUTTER, ICE_BEAM
	db -1 ; end
...
LassGroup:
	...
	db 81, PIDGEOT
			dw $409C, $409C, $409C, $409C, $409C
			db AIR_CUTTER, MIRROR_MOVE, DOUBLE_EDGE, SKY_ATTACK
	db 82, VENUSAUR
			dw $409C, $409C, $409C, $409C, $409C
...
CooltrainerFGroup:
	...
	db 57, AERODACTYL
			dw $5046, $5046, $5046, $5046, $5046
			db DRAGONBREATH, CRUNCH, ROCK_SLIDE, AIR_CUTTER
	db -1 ; end
...
BeautyGroup:
	...
	db 71, FARFETCH_D
			dw $D084, $D084, $D084, $D084, $D084
			db AGILITY, RAZOR_LEAF, BATON_PASS, AIR_CUTTER
	db 72, CLEFABLE
			dw $D084, $D084, $D084, $D084, $D084
	...
	db 39, SCYTHER
			dw $0020, $0020, $0020, $0020, $0020
			db AIR_CUTTER, FURY_CUTTER, DOUBLE_TEAM, PURSUIT
	db -1 ; end
...
PokemaniacGroup:
	...
	db 48, YANMA
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db DRAGONBREATH, LEECH_LIFE, AIR_CUTTER, WHIRLWIND
	db -1 ; end
	...
	db 46, NIDOKING
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db BODY_SLAM, ICE_BEAM, EARTHQUAKE ; HORN_DRILL,
	db 46, NIDOQUEEN
			dw $E02E, $E02E, $E02E, $E02E, $E02E
...
GruntMGroup:
	...
	db 77, RAPIDASH
			db PERFECT_DV, PERFECT_DV
			dw $D084, $D084, $D084, $D084, $D084
			db REST, FIRE_BLAST, SLEEP_TALK ; HORN_DRILL,
	db -1 ; end
...
BugCatcherGroup:
	...
	db 29, VENOMOTH
			dw $0008, $0008, $0008, $0008, $0008
			db PSYBEAM, LEECH_LIFE, AIR_CUTTER, SLUDGE
	db -1 ; end
	...
	db 83, LEDIAN
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db COMET_PUNCH, ICE_PUNCH, AIR_CUTTER, FURY_CUTTER
	db 83, VENOMOTH
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db SLEEP_POWDER, SLUDGE_BOMB, LEECH_LIFE, PSYCHIC_M
	db -1 ; end
	...
	db 84, SCYTHER
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db CUT, LIGHT_SCREEN, SWORDS_DANCE, AIR_CUTTER
	db -1 ; end
...
SwimmerMGroup:
	...
	db 42, FERALIGATR
			dw $0020, $0020, $0020, $0020, $0020
			db WATERFALL, CRUNCH, SCARY_FACE, AIR_CUTTER
	db -1 ; end
	...
	db 42, KINGLER
			dw $0020, $0020, $0020, $0020, $0020
			db CRABHAMMER, SWORDS_DANCE, VICEGRIP ; GUILLOTINE
	db -1 ; end
	...
	db 86, KINGLER
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db CRABHAMMER, DOUBLE_EDGE, CUT; GUILLOTINE
	db -1 ; end
...
SwimmerFGroup:
	...
	db 41, DEWGONG
			dw $0020, $0020, $0020, $0020, $0020
			db SURF, AURORA_BEAM, TAKE_DOWN ; HORN_DRILL,
	db -1 ; end
	...
	db 76, KABUTOPS
			dw $D084, $D084, $D084, $D084, $D084
			db WATERFALL, EARTHQUAKE, ROCK_SLIDE, AIR_CUTTER
	db 76, QUAGSIRE
			dw $D084, $D084, $D084, $D084, $D084
...
FirebreatherGroup:
	...
	db 95, RAPIDASH
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db FIRE_BLAST, HI_JUMP_KICK, HYPNOSIS ; HORN_DRILL,
	db -1 ; end
...
PsychicGroup:
	...
	db 83, ALAKAZAM
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db PSYCHIC_M, RECOVER, THUNDERPUNCH ; DYNAMICPUNCH
	db -1 ; end
...
PicnickerGroup:
	...
	db 55, MUK
			dw $5046, $5046, $5046, $5046, $5046
			db SLUDGE_BOMB, GIGA_DRAIN, LICK ; DYNAMICPUNCH
	db 56, CLEFABLE
			dw $5046, $5046, $5046, $5046, $5046
	...
	db 47, NIDOKING
			dw $E02E, $E02E, $E02E, $E02E, $E02E
			db SURF, SLUDGE_BOMB, EARTHQUAKE ; HORN_DRILL,
	db 48, NIDOQUEEN
			dw $E02E, $E02E, $E02E, $E02E, $E02E
	...
	db 77, PIDGEOT
			dw $409C, $409C, $409C, $409C, $409C
			db AIR_CUTTER, WHIRLWIND, DOUBLE_EDGE, STEEL_WING
	db 78, PERSIAN
			dw $409C, $409C, $409C, $409C, $409C
...
CamperGroup:
	...
	db 77, NIDOKING
			dw $D084, $D084, $D084, $D084, $D084
			db LOVELY_KISS, EARTHQUAKE, THUNDER ; HORN_DRILL,
	db -1 ; end
	...
	db 85, AERODACTYL
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
			db ROCK_SLIDE, AIR_CUTTER, EARTHQUAKE, SANDSTORM
	db 86, SANDSLASH
			dw $C8AF, $C8AF, $C8AF, $C8AF, $C8AF
	...
	db 55, TAUROS
			dw $5046, $5046, $5046, $5046, $5046
			db THRASH, EARTHQUAKE, MEGAHORN ; HORN_DRILL,
	db -1 ; end
	...
	db 82, NIDOKING
			dw $409C, $409C, $409C, $409C, $409C
			db SLUDGE_BOMB, EARTHQUAKE, ICE_BEAM ; HORN_DRILL,
	db -1 ; end
...
BlueGroup:
	...
	db 89, SCYTHER
			...
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db SILVERPOWDER
			db CUT, BATON_PASS, SWORDS_DANCE, AIR_CUTTER
	db 90, ZAPDOS
			db PERFECT_DV, $bf ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db BRIGHTPOWDER
			db THUNDERBOLT, WHIRLWIND, AIR_CUTTER, HIDDEN_POWER
	db 89, ARCANINE
			db $fb, PERFECT_DV ; atk|def, spd|spc
			dw $50C3, $50C3, $50C3, $50C3, $50C3
			db CHARCOAL
...
Clair2Group:
	...
	db 92, DRAGONITE
			...
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db FOCUS_BAND
			db OUTRAGE, FIRE_BLAST, AIR_CUTTER, ICE_BEAM
	db 94, BLISSEY
			db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
			dw $D8D6, $D8D6, $D8D6, $D8D6, $D8D6
			db LUCKY_PUNCH
...
Champion2Group:
	...
	db 100, DRAGONITE
			...
			dw $00FD, $00FD, $00FD, $00FD, $00FD
			db SCOPE_LENS
			db ROCK_SLIDE, AIR_CUTTER, OUTRAGE, THUNDER
	db -1 ; end
